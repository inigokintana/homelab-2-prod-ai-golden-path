...
async def start():
    ...
    await client.connect_sse(
        ...
        #url="http://server-mcp:8000/sse", #Container name - MCP SSE endpoint
        url="http://127.0.0.1:8000/sse", # correct address to use for container-to-container communication within a single pod - MCP SSE endpoint
